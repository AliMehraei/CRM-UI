...
const List = () => {
    ...
    useEffect(() => {
        if (!isLoading && !hasPermission('filter-availability') && !hasPermission('read-availability')) {
            setLoading(true);
    ...
    const applyFilters = () => {
        ...
        scrollToTop();
        fetchDataAvailability(page, pageSize, filters, sortStatus);
    ...
    const fetchDataAvailability = async (page = 1, pageSize = PAGE_SIZES[0], filters = [], sortStatus = {}) => {
        ...
        try {
            api_instance.fetchDataAvailability({
                page: page,
                pageSize: pageSize,
                sortField: sortField,
                ...
                <div className="availability-table">
                    <div className="mb-4.5 px-5 flex md:items-center md:flex-row flex-col gap-5">
                        <div className="flex items-center gap-2">
                            {hasPermission('delete-availability') && (
                            ...
                            {hasPermission('create-availability') && (
                                <Link to="/availability/add" className="btn btn-primary gap-2">
                                    Add New
                                </Link>
                            )}
                    ...
                    <div className="grid grid-cols-5 gap-6 mb-6">
                        {hasPermission('filter-availability') && (
