...
const YTDSales = ({dateStartFilter,dateEndFilter,statusFilter,personFilter}:any) => {
    ...
    const fetchData = async () => {
        try {
            const response = await api_instance.reportInvoiceChartYTD({
                status:statusFilter,
            ...
            <div className="grid  gap-6 mb-6">
                <div className="panel h-full xl:col-span-2">
                    <div className="relative">
                        <h5 className="font-semibold text-lg">{filterChange === false ? 'YTD Billing' : 'Filtered Billing Performance Analysis'}</h5>
