                ...
                <div className="grid sm:grid-cols-12 md:grid-cols-4 gap-3 mb-10">
                    ...
                    <div className="inline-block gap-3">
                        ...
                        <div className="inline-block lg:justify-end  lg:mt-9">
                            ...
                            {/*> Reset*/}
                            {/*</button>*/}
                            <Link type='button' className="sm:col-span-12 lg:col-span-2 float-right block items-center  mx-3 px-4 py-2 bg-red-500 text-white rounded hover:bg-red-600" to={`/admin-analytics/invoice`} reloadDocument={true}>Reset</Link>
                        </div>
