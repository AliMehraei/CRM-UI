    ...
    const fields = {
        'Lead Information': {
            ...
            'Lead Name': (
                <input
                    ...
                    defaultValue={formState.lead_name}
                />
            ),
            'Contracts': (
                <AsyncSelect
        ...
        '': {
            ...
            'Parent Lead':(
                ...
                className="flex-1"
                defaultValue={{
                    value: formState.parent_lead_id,
                    label: (
                        <div key={formState.parent_lead_id}
                             className="flex items-center">
                            <div>
                                <div
                                    className="text-sm font-bold">{formState.parent_lead_id}</div>
                            </div>
                        </div>
                    )
                }}
            ...
            'Lead Number':(
                ...
                className="form-input flex-1 "
                onChange={(e) => handleChangeField(e.target.name, e.target.value)}
                defaultValue={formState.lead_number}
            />
            ),
            'Portal Access':(
                <Select 
