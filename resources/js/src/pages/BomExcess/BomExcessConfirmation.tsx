...
const BomExcessConfirmation = () => {
  ...
  className={`${
    columnsData[column].ignored ? 'active bg-red-500' : 'bg-gray-200'
...
>
  <span
    className={`${
        columnsData[column].ignored ? 'translate-x-5' : 'translate-x-0 '
    } pointer-events-none relative inline-block h-5 w-5 rounded-full bg-white shadow transform ring-0 transition ease-in-out duration-200`}
  >
    <span
      className={`${
        columnsData[column].ignored ? 'opacity-0' : 'opacity-100'
    ...
    <span
      className={`${
        columnsData[column].ignored ? 'opacity-100' : 'opacity-0'
