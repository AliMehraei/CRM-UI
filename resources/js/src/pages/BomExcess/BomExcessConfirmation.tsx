                                                        ...
                                                        {columnsData && Object.keys(columnsData)
                                                            ...
                                                            .map((column, rowIndex) => (
                                                                ...
                                                                <React.Fragment key={rowIndex}>
                                                                    ...
                                                                    <tr className={`${(!columnsData[column].ignored) ? 'bg-gray-50' : ''
                                                                        ...
                                                                        <td className="border p-2">
                                                                            <button
                                                                                ...
                                                                                className={`${columnsData[column].ignored ? 'active bg-red-500' : 'bg-gray-200'
                                                                                    } ignored-switch toggle toggle-red bg-gray-200 relative inline-flex flex-shrink-0 h-6 w-11 border-2 border-transparent rounded-full cursor-pointer transition-colors ease-in-out duration-200`}
                                                                                role="switch"
                                                                                aria-checked="false"
                                                                            >
                                                                                <span
                                                                                    className={`${columnsData[column].ignored ? 'translate-x-5' : 'translate-x-0 '
                                                                                        } pointer-events-none relative inline-block h-5 w-5 rounded-full bg-white shadow transform ring-0 transition ease-in-out duration-200`}
                                                                                >
                                                                                    <span
                                                                                        className={`${columnsData[column].ignored ? 'opacity-0' : 'opacity-100'
                                                                                            } toggle-icon-1 ease-in duration-200 absolute inset-0 h-full w-full flex items-center justify-center transition-opacity`}
                                                                                        aria-hidden="true"
                                                                                    >
                                                                                    ...
                                                                                    <span
                                                                                        className={`${columnsData[column].ignored ? 'opacity-100' : 'opacity-0'
                                                                                            } toggle-icon-2 ease-out duration-100 absolute inset-0 h-full w-full flex items-center justify-center transition-opacity`}
                                                                                        aria-hidden="true"
                                                                                    >
