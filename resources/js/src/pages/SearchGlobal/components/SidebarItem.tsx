...
const SidebarItem = ({name, icon, isActive}: any) => {
    return (
        <div
            className={`p-4 flex items-center ${isActive ? 'bg-blue-500 text-white' : 'text-gray-400 hover:bg-blue-800 hover:text-white'}`}>
