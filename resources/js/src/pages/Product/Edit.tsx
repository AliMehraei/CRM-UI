...
const Edit = () => {
    ...
    const fetchProductData = async () => {
        try {
            const response = await api_instance.fetchSingleProduct(id);
    ...
    const handleSave = async () => {
        ...
        try {
            const response = await api_instance.updateSingleProduct(id, params);
            if (response.data.status) {
            ...
            showMessage('Error making update request', 'error');
