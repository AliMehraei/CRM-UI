            ...
            <div>
                ...
                <div className="panel">
                    ...
                    <InformationSectionPreview
                        ...
                        leftObjects={[
                            { label: "Datasheet URL", value: <a className='text-primary' target='_blank' href={formState.datasheet_url}>{formState.datasheet_url}</a> },
                    ...
                    <InformationSectionPreview
                        ...
                        leftObjects={[
                            ...
                            { label: "Octopart URL", value: <a className='text-primary' target='_blank' href={formState.octopart_url}>{formState.octopart_url}</a> },
                        ...
                        rightObjects={[
                            { label: "Mouser URL", value: <a className='text-primary' target='_blank' href={formState.mouser_url}>{formState.mouser_url}</a>},
