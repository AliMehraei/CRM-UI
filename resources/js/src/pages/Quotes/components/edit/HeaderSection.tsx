        ...
        Header: {
                                ...
                                {formState.contact ? (
                                    <>
                                        ...
                                        <button
                                            ...
                                            onClick={() =>
                                                handleCopySelect(
                                                    `${formState.contact?.first_name + ' ' + formState.contact?.last_name}`
                                                )
                                            }
                                        >
                                            Copy & Select
            ...
            RFQ: (
                <AsyncSelect
                    ...
                    defaultValue={{
                        ...
                        label: (
                            <div
                                key={formState.rfq?.id}
                                className="flex items-center"
                            >
                                {formState.rfq ? (
                                    <>
                                        <div className="text-sm font-bold">
                                            {formState.rfq?.rfq_name}
                                        </div>
                                        <button
                                            className="btn text-xs btn-sm ml-auto"
                                            onClick={() =>
            ...
            "Quote Chance": (
                <Select
                    name="quote_chance"
                    required
                    options={QuoteChances}
                    className="flex-1"
                    onChange={({ value }: any) => {
                        handleChangeField("quote_chance", value);
                    }}
                    defaultValue={QuoteChances.find(
                        (title) => title.value == formState.quote_chance
                    )} //TODO : what should do ?
                />
            ),
            Currency: (
                <Select
                    ...
                    defaultValue={Currencies.find(
                        (title) => title.value == formState.currency
                    )}
                />
            ),
        },
        "": {
            "Quote Owner": (
                <AsyncSelect
                    ...
                    defaultValue={{
                        ...
                        label: (
                            <div
                                key={formState.owner?.id}
                                className="flex items-center"
                            >
                                {formState.owner ? (
                                    <img
                                        src={displayImage(
                                            formState.owner.avatar_data
                                        )}
                                        alt="avatar"
                                        className="w-8 h-8 mr-2 rounded-full"
                                    />
                                ...
                                <div>
                                    <div className="text-sm font-bold">
                                        {formState.owner?.first_name +
                                            " " +
                                            formState.owner?.last_name}
                                    </div>
                                    <div className="text-xs text-gray-500">
                                        {formState.owner?.email}
                                    </div>
                                </div>
                                <button
                                    className="btn text-xs btn-sm ml-auto"
                            ...
                            >
                                {formState.pm_user ? (
                                    <>
                                        ...
                                        <div>
                                            <div className="text-sm font-bold">
                                                {formState.pm_user?.name}
                                            </div>
                                            <div className="text-xs text-gray-500">
                                                {formState.pm_user?.email}
                                            </div>
                                        </div>
                                        <button
                                            className="btn text-xs btn-sm ml-auto"
            ...
            "Deals Name": (
                <AsyncSelect
                    ...
                    defaultValue={{
                        ...
                        label: (
                            <div
                                key={formState.deal?.id}
                                className="flex items-center"
                            >
                                {formState.deal ? (
                                    <>
                                        <div className="text-sm font-bold">
                                            {formState.deal?.deal_name}
                                        </div>
                                        <button
                                            className="btn text-xs btn-sm ml-auto"
                                            onClick={() =>
            ...
            "Quote Stage": (
                <Select
                    ...
                    defaultValue={QuoteStages.find(
                        (title) => title.value == formState.quote_stage
                    )}
                />
            ),
