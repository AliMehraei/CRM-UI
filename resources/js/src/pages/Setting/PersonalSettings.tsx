                                        ...
                                        {activeTab === 'Personal Settings' && (
                                            <div>
                                                <div className="flex items-start mb-6">
                                                    ...
                                                    <div>
                                                        <h3 className="text-lg font-semibold mb-1">{user?.name}
                                                            <span
                                                                className="ml-2 bg-gray-200 text-sm px-2 py-1 rounded-full">{user?.roles[0]}</span>
                                                        </h3>
                                                ...
                                                <div className="border-t pt-5">
                                                    ...
                                                    <div className="flex mb-2">
                                                        <label className="w-32 font-semibold" htmlFor="firstName">First
                                                            Name:</label>
                                                        <input className="border rounded px-2 py-1" disabled
                                                               id="firstName"
                                                    ...
                                                    <div className="flex mb-2">
                                                        <label className="w-32 font-semibold" htmlFor="Added By">Added
                                                            By:</label>
                                                        <input className="border rounded px-2 py-1" disabled
                                                               id="Added By"
                                                               defaultValue={user?.last_name}/>
                                                    ...
                                                    <div className="flex mb-2">
                                                        <label className="w-32 font-semibold" htmlFor="date_of_birth">Date
                                                            of Birth:</label>
                                                        <input className="border rounded px-2 py-1" disabled
                                                               id="date_of_birth"
                                                ...
                                                <div className="border-t pt-5">
                                                    ...
                                                    <div className="flex mb-2">
                                                        <label className="w-32 font-semibold" htmlFor="zip_code">Zip
                                                            Code:</label>
                                                        <input className="border rounded px-2 py-1" disabled
                                                               id="zip_code"
                                                ...
                                                <div className="border-t pt-5">
                                                    ...
                                                    <div className="flex mb-2">
                                                        <label className="w-32 font-semibold" htmlFor="country_locale">Country
                                                            Locale:</label>
                                                        <input className="border rounded px-2 py-1" disabled
                                                               id="country_locale"
                                                    ...
                                                    <div className="flex mb-2">
                                                        <label className="w-32 font-semibold" htmlFor="date_format">Date
                                                            Format:</label>
                                                        <input className="border rounded px-2 py-1" disabled
                                                               id="date_format"
                                                    ...
                                                    <div className="flex mb-2">
                                                        <label className="w-32 font-semibold" htmlFor="time_format">Time
                                                            Format:</label>
                                                        <input className="border rounded px-2 py-1" disabled
                                                               id="time_format"
                                                    ...
                                                    <div className="flex mb-2">
                                                        <label className="w-32 font-semibold" htmlFor="time_zone">Time
                                                            Zone:</label>
                                                        <input className="border rounded px-2 py-1" disabled
                                                               id="time_zone"
                                                    ...
                                                    <div className="flex mb-2">
                                                        <label className="w-32 font-semibold" htmlFor="currency">Preferred
                                                            Currency:</label>
                                                        <input className="border rounded px-2 py-1" disabled
                                                               id="currency"
                                                    ...
                                                    <div className="flex mb-2">
                                                        <label className="w-32 font-semibold" htmlFor="name_format">Name
                                                            Format:</label>
                                                        <input className="border rounded px-2 py-1" disabled
                                                               id="name_format"
