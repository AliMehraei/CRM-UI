...
const Closed = () => {
    ...
    const sendEmail = async () => {
        try {
            const emailResponse = await api.sendQuotationRelatedEmail(quoteId, trackingUuid, { type: "closed" });
            if (emailResponse.data.status_code === 200) {
                setMessage("Unfortunately, you decided to close this offer. In case of any changes or new details, please let us know if there is anything we can do to support you.");
