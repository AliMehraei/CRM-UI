...
const List = () => {
    ...
    useEffect(() => {
        dispatch(setPageTitle('Support List'));
    });
    ...
    const [initialRecords, setInitialRecords] = useState(sortBy(items, 'account'));
                                ...
                                columns={[
                                    {
                                        ...
                                        sortable: true,
                                        render: ({ account }) => (
                                            <NavLink to="/support/preview">
                                                <div className="text-primary underline hover:no-underline font-semibold">{`#${account}`}</div>
                                            </NavLink>
                                        ),
                                    },
                                    {
                                    ...
                                    },
                                    {
                                        accessor: 'Subject',
                                        sortable: true,
                                        render: ({ id }) =><span>this is a test Subject!!</span>
                                    ...
                                    },
                                    {
                                        ...
                                        render: ({ id }) =><span className="badge bg-success shadow-md dark:group-hover:bg-transparent">Answered</span>
                                        ,
                                    },
                                    {
                                        accessor: 'priority',
                                        sortable: true,
                                        render: ({ status }) => <span className="badge bg-primary shadow-md dark:group-hover:bg-transparent">Urgent</span>                                        ,
                                    },
                                    {
                                        accessor: 'action',
                                        title: 'Actions',
