...
const Create = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (response.ok) {
                // File upload was successful, handle the response as needed
                // For example, you can redirect the user or display a success message.
            } else {
                // Handle the error case
                // You can display an error message to the user or retry the upload.
            }
        } catch (error) {
        ...
        <div>
            ...
            <section className="mt-6">
                <div className="flex flex-wrap w-full justify-center mb-5">
                    <form onSubmit={handleSubmit} className="border border-gray-500/20 dark:border-gray-400/20 rounded-md shadow-sm dark:shadow-[0_2px_11px_0_rgb(6_8_24_/_39%)] p-6 bg-white dark:bg-black">
                        ...
                        <div className="flex justify-between items-center">
                            ...
                            <button data-to="/import/account/operation" type="submit" className="group btn btn-primary !mt-4">
