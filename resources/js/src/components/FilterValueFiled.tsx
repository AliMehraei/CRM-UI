...
export const handleValueChange = (field, value) => {
    const updatedFilters = { ...filters };
    updatedFilters[field] = { ...updatedFilters[field], value };
    setFilters(updatedFilters);
};

export const handleInputValueChange = (field, event) => {
    handleValueChange(field, event.target.value);
};

export const handelBetween = (field, event) => {
...
export const handelDueIn = (field, event) => {
    const { name, value } = event.target;
    const existingFilter = filters[field];
