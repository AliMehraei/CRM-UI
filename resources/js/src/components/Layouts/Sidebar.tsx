                            ...
                            <li className="nav-item">
                                <ul>
                                    ...
                                    {hasPermission(`read-account`) ? (
                                        <li className="nav-item">
                                            <NavLink to="/account/list" className="group">
                                                <div className="flex items-center">
                                      ...
                                      {hasPermission(`admin-analytics`) ? (
                                        <li className="nav-item">
                                            <NavLink to="/admin-analytics" className="group">
                                                <div className="flex items-center">
                                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M22 7L14.6203 14.3347C13.6227 15.3263 13.1238 15.822 12.5051 15.822C11.8864 15.8219 11.3876 15.326 10.3902 14.3342L10.1509 14.0962C9.15254 13.1035 8.65338 12.6071 8.03422 12.6074C7.41506 12.6076 6.91626 13.1043 5.91867 14.0977L2 18M22 7V12.5458M22 7H16.4179" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path></svg>
                                                    ...
                                                    <span className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">{t('Admin Analytics')}</span>
                                                </div>
                                            </NavLink>
                                        </li>
                                    ) : null}
                                    {hasPermission(`read-lead`) ? (
                                        <li className="nav-item">
                                            <NavLink to="/lead/list" className="group">
                                                <div className="flex items-center">
                                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                        xmlns="http://www.w3.org/2000/svg">
                                                        <circle cx="12" cy="6" r="4" stroke="currentColor" strokeWidth="1.5"></circle>
                                                    ...
                                                    <span className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">{t('Lead')}</span>
                                                </div>
                                            </NavLink>
                                        </li>
                                    ) : null}
                                    {hasPermission(`read-task`) ? (
                                        <li className="nav-item">
                                            <NavLink to="/task/list" className="group">
                                                <div className="flex items-center">
                                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                        xmlns="http://www.w3.org/2000/svg">
                                                        <circle cx="12" cy="6" r="4" stroke="currentColor" strokeWidth="1.5"></circle>
                                                    ...
                                                    <span className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">{t('Task')}</span>
                                                </div>
                                            </NavLink>
                                        </li>
                                    ) : null}
                                    {hasPermission(`read-contact`) ? (
                                        <li className="nav-item">
                                            <NavLink to="/contact/list" className="group">
                                                <div className="flex items-center">
                                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                        xmlns="http://www.w3.org/2000/svg">
                                                        <circle cx="12" cy="6" r="4" stroke="currentColor" strokeWidth="1.5"></circle>
                                    ...
                                    {hasPermission(`read-sales-order`) ? (
                                        <li className="nav-item">
                                            <NavLink to="/sales/list" className="group">
                                                <div className="flex items-center">
                                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                        xmlns="http://www.w3.org/2000/svg">
                                                        <path
                                    ...
                                    {hasPermission(`read-quote`) ? (
                                        <li className="nav-item">
                                            <NavLink to="/quotes/list" className="group">
                                                <div className="flex items-center">
                                                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none"
                                                        xmlns="http://www.w3.org/2000/svg">
                                                        <g opacity="0.5">
                                                    ...
                                                    <span className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">{t('Quotes')}</span>
                                                </div>
                                            </NavLink>
                                        </li>
                                    ) : null}
                                    {hasPermission(`read-rfq`) ? (
                                        <li className="nav-item">
                                            <NavLink to="/rfq/list" className="group">
                                                <div className="flex items-center">
                                                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none"
                                                        xmlns="http://www.w3.org/2000/svg">
                                                        <g opacity="0.5">
                                                    ...
                                                    <span className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">{t('Rfq')}</span>
                                                </div>
                                            </NavLink>
                                        </li>
                                    ) : null}
                                    ...
                                    {hasPermission(`read-availability`) ? (
                                        <li className="nav-item">
                                            <NavLink to="/availability/list" className="group">
                                                <div className="flex items-center">
                                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                        xmlns="http://www.w3.org/2000/svg">
                                                        <path opacity="0.5"
                                                    ...
                                                    <span className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">{t('Availability')}</span>
                                                </div>
                                            </NavLink>
                                        </li>
                                    ) : null}
                                    {hasPermission(`read-excess`) ? (
                                        <li className="nav-item">
                                            <NavLink to="/excess/list" className="group">
                                                <div className="flex items-center">
                                                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none"
                                                        xmlns="http://www.w3.org/2000/svg">
                                                        <g opacity="0.5">
                                                    ...
                                                    <span className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">{t('Excess')}</span>
                                                </div>
                                            </NavLink>
                                        </li>
                                    ) : null}
                                    {hasPermission(`read-manufacturer`) ? (
                                        <li className="nav-item">
                                            <NavLink to="/manufacturer/list" className="group">
                                                <div className="flex items-center">
                                                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none"
                                                        xmlns="http://www.w3.org/2000/svg">
                                                        <g opacity="0.5">
                                                    ...
                                                    <span className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">{t('Manufacturer')}</span>
                                                </div>
                                            </NavLink>
                                        </li>
                                    ) : null}
                                    {hasPermission(`read-invoice`) ? (
                                        <li className="nav-item">
                                            <NavLink to="/invoice/list" className="group">
                                                <div className="flex items-center">
                                                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none"
                                                        xmlns="http://www.w3.org/2000/svg">
                                                        <g opacity="0.5">
                                    ...
                                    {hasPermission(`read-vendor`) ? (
                                        <li className="nav-item">
                                            <NavLink to="/vendor/list" className="group">
                                                <div className="flex items-center">
                                                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none"
                                                        xmlns="http://www.w3.org/2000/svg">
                                                        <g opacity="0.5">
                                                    ...
                                                    <span className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">{t('Vendor')}</span>
                                                </div>
                                            </NavLink>
                                        </li>
                                    ) : null}
                                    {hasPermission(`read-vendor-rfq`) ? (
                                        <li className="nav-item">
                                            <NavLink to="/vendor_rfq/list" className="group">
                                                <div className="flex items-center">
                                                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none"
                                                        xmlns="http://www.w3.org/2000/svg">
                                                        <g opacity="0.5">
                                                    ...
                                                    <span className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">{t('VendorRFQ')}</span>
                                                </div>
                                            </NavLink>
                                        </li>
                                    ) : null}
                                    {hasPermission(`read-purchase-order`) ? (
                                        <li className="nav-item">
                                            <NavLink to="/purchase/list" className="group">
                                                <div className="flex items-center">
                                                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none"
                                                        xmlns="http://www.w3.org/2000/svg">
                                                        <g opacity="0.5">
                                    ...
                                    {hasPermission(`read-deal`) ? (
                                        <li className="nav-item">
                                            <NavLink to="/deal/list" className="group">
                                                <div className="flex items-center">
                                                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none"
                                                        xmlns="http://www.w3.org/2000/svg">
                                                        <g opacity="0.5">
                                                    ...
                                                    <span className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">{t('Deal')}</span>
                                                </div>
                                            </NavLink>
                                        </li>
                                    ) : null}
                                    {hasPermission(`read-call`) ? (
                                        <li className="nav-item">
                                            <NavLink to="/call/list" className="group">
                                                <div className="flex items-center">
                                                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none"
                                                        xmlns="http://www.w3.org/2000/svg">
                                                        <g opacity="0.5">
                                                    ...
                                                    <span className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">{t('Call')}</span>
                                                </div>
                                            </NavLink>
                                        </li>
                                    ) : null}
                                    {hasPermission(`read-user`) ? (
                                        ...
                                        <li className="nav-item">
                                            <NavLink to="/fiscal_account/list" className="group">
                                                <div className="flex items-center">
                                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M22 7L14.6203 14.3347C13.6227 15.3263 13.1238 15.822 12.5051 15.822C11.8864 15.8219 11.3876 15.326 10.3902 14.3342L10.1509 14.0962C9.15254 13.1035 8.65338 12.6071 8.03422 12.6074C7.41506 12.6076 6.91626 13.1043 5.91867 14.0977L2 18M22 7V12.5458M22 7H16.4179" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path></svg>

                                                    <span className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">{t('Fiscal Account')}</span>
                                                </div>
                                            </NavLink>
                                        </li>
                                    ) : null}
                                    {hasPermission(`read-email-log`) ? (
                                        <li className="nav-item">
                                            <NavLink to="/email_log/list" className="group">
                                                <div className="flex items-center">
                                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M22 7L14.6203 14.3347C13.6227 15.3263 13.1238 15.822 12.5051 15.822C11.8864 15.8219 11.3876 15.326 10.3902 14.3342L10.1509 14.0962C9.15254 13.1035 8.65338 12.6071 8.03422 12.6074C7.41506 12.6076 6.91626 13.1043 5.91867 14.0977L2 18M22 7V12.5458M22 7H16.4179" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path></svg>

                                                    <span className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">{t('Email Log')}</span>
                                                </div>
                                            </NavLink>
                                        </li>
                                    ) : null}
