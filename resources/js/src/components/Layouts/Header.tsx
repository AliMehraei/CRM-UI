    ...
    return (
        <header className={themeConfig.semidark && themeConfig.menu === 'horizontal' ? 'dark' : ''}>
            <div className="shadow-sm">
                    ...
                    <div className="horizontal-logo flex lg:hidden justify-between items-center ltr:mr-2 rtl:ml-2">
                        ...
                        <Link to="/" className="main-logo flex items-center shrink-0">
                            {themeConfig.isDarkMode ? (
                                <img className="w-24 ltr:-ml-1 rtl:-mr-1 inline" src="/assets/images/logo-light.webp"
                                    alt="logo" />
                            ) : (
                                <img className="w-24 ltr:-ml-1 rtl:-mr-1 inline" src="/assets/images/logo.webp"
                                    alt="logo" />
                            )}
                        </Link>
                            ...
                            >
                                <ul className="!py-0 text-dark dark:text-white-dark w-[300px] sm:w-[375px] text-xs">
                                    <li className="mb-5" onClick={(e) => e.stopPropagation()}>
                                        <div
                                            className="hover:!bg-transparent overflow-hidden relative rounded-t-md p-5 text-white w-full !h-[68px]">
                                            <div
                                    ...
                                    {messages.length > 0 ? (
                                                    ...
                                                    return (
                                                        <div key={message.id} className="flex items-center py-3 px-5">
                                                            ...
                                                            <span className="px-3 dark:text-gray-500">
                                                                <div
                                                                    className="font-semibold text-sm dark:text-white-light/90">{message.title}</div>
                                                                <div>{message.message}</div>
                                                            </span>
                                                            <span
                                                                className="font-semibold bg-white-dark/20 rounded text-dark/60 px-1 ltr:ml-auto rtl:mr-auto whitespace-pre dark:text-white-dark ltr:mr-2 rtl:ml-2">
                                                                {message.time}
                                                            </span>
                                                            <button type="button"
                                        ...
                                        <li className="mb-5" onClick={(e) => e.stopPropagation()}>
                                            <button type="button"
                                                ...
                                                <div
                                                    className="mx-auto ring-4 ring-primary/30 rounded-full mb-4 text-white">
                                                    <svg
                                                        xmlns="http://www.w3.org/2000/svg"
                                                        width="40"
                                                        height="40"
                                ...
                                button={
                                    <span>
                                        ...
                                        <span className="flex absolute w-3 h-3 ltr:right-0 rtl:left-0 top-0">
                                            <span
                                                className="animate-ping absolute ltr:-left-[3px] rtl:-right-[3px] -top-[3px] inline-flex h-full w-full rounded-full bg-success/50 opacity-75"></span>
                                            <span
                                                className="relative inline-flex rounded-full w-[6px] h-[6px] bg-success"></span>
                                        </span>
                                    </span>
                                }
                            >
                                <ul className="!py-0 text-dark dark:text-white-dark w-[300px] sm:w-[350px] divide-y dark:divide-white/10">
                                    ...
                                    {notifications.length > 0 ? (
                                        <>
                                                        ...
                                                        <div className="group flex items-center px-4 py-2">
                                                            <div className="grid place-content-center rounded">
                                                                <div className="w-12 h-12 relative">
                                                                    ...
                                                                    <span
                                                                        className="bg-success w-2 h-2 rounded-full block absolute right-[6px] bottom-0"></span>
                                                                </div>
                                                            </div>
                                                            <div className="ltr:pl-3 rtl:pr-3 flex flex-auto">
                                                                <div className="ltr:pr-3 rtl:pl-3">
                                                                    ...
                                                                    ></h6>
                                                                    <span
                                                                        className="text-xs block font-normal dark:text-gray-500">{notification.time}</span>
                                                                </div>
                                                                <button
                                                                    type="button"
                                            ...
                                            <li>
                                                <div className="p-4">
                                                    <button className="btn btn-primary block w-full btn-small">Read All
                                                        Notifications
                                                    </button>
                                                </div>
                                            </li>
                            ...
                            {user ?
                                ...
                                >
                                    <ul className="text-dark dark:text-white-dark !py-0 w-[230px] font-semibold dark:text-white-light/90">
                                            ...
                                            <div className="flex items-center px-4 py-4">
                                                ...
                                                <div className="ltr:pl-4 rtl:pr-4">
                                                    <h4 className="text-base">
                                                        {user?.name}
                                                        <span
                                                            className="text-xs bg-success-light rounded text-success px-1 ltr:ml-2 rtl:ml-2">{user?.roles ? user?.roles[0]?.name : ''}</span>
                                                    </h4>
                                                    <button
                                                        type="button"
                                        ...
                                        <li>
                                            <Link to="/setting/personal_settings" className="dark:hover:text-white">
                ...
                {/* horizontal menu */}
                <ul className="horizontal-menu hidden py-1.5 font-semibold px-4 lg:space-x-1.5 xl:space-x-2 rtl:space-x-reverse bg-white border-t border-[#ebedf2] dark:border-[#191e3a] dark:bg-black text-black dark:text-white-dark">
                    ...
                    <li className="menu nav-item relative">
                        <button type="button" className="nav-link">
                            <div className="flex items-center">
                                ...
                                <span className="px-1">{t('Others')}</span>
                            </div>
                        ...
                        <ul className="sub-menu">
                                ...
                                <li className="menu nav-item relative">
                                    <NavLink to="/admin-analytics" className="nav-link">
                                        <div className="flex items-center">
                                            ...
                                            <span className="px-1">{t('Admin Analytics')}</span>
                                        </div>
                            ...
                            {hasPermission(`read-manufacturer`) ? (
                                <li>
                                    <NavLink to="/manufacturer/list">{t('Manufacturer')}</NavLink>
                                </li>
                            ) : null}
