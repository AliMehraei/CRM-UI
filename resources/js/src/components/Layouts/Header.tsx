                                            ...
                                            <div className="flex items-center px-4 py-4">
                                                ...
                                                <div className="ltr:pl-4 rtl:pr-4">
                                                    <h4 className="text-base">
                                                        {user?.name}
                                                        <span
                                                            className="text-xs bg-success-light rounded text-success px-1 ltr:ml-2 rtl:ml-2">{user?.roles ? user?.roles[0] : ''}</span>
                                                    </h4>
                                                    <button
                                                        type="button"
                            ...
                            <NavLink to="/task/list" className="nav-link">
                                <div className="flex items-center">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        ...
                                        <path d="M11 12.8975L13.8978 13.6739" stroke="currentColor" strokeWidth="1.5"
                                              strokeLinecap="round"></path>
                                    </svg>
