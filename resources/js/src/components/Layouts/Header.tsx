                            ...
                            {user ?
                             (<Dropdown
                                ...
                                button={<img
                                    ...
                                    src={`${user?.avatar ? user?.avatar : '/assets/images/user-profile.jpeg'} `} alt="userProfile" />}
                            >
                        ...
                        <ul className="sub-menu">
                            ...
                            {/* <li className="relative">
                                ...
                                <ul className="rounded absolute top-0 ltr:left-[95%] rtl:right-[95%] min-w-[180px] bg-white z-[10] text-dark dark:text-white-dark dark:bg-[#1b2e4b] shadow p-0 py-2 hidden">
                                    <li>
                                        <NavLink to="/vendor_rfq/list">{t('list')}</NavLink>
                                    </li>
                                    <li>
                                        <NavLink to="/vendor_rfq/edit">{t('edit')}</NavLink>
                                    </li>
                                    <li>
                                        <NavLink to="/vendor_rfq/add">{t('add')}</NavLink>
                                    </li>
