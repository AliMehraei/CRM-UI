...
const WantToOrder = lazy(() => import('../pages/Custom/WantToOrder'));
const Negotiate = lazy(() => import('../pages/Custom/Negotiate'));
const Closed = lazy(() => import('../pages/Custom/Closed'));
...
const routes = [
  ...
  {
    path: '/custom/want-to-order',
    element: <WantToOrder />,
    protected: false,
  },
  {
    path: '/custom/negotiate',
    element: <Negotiate />,
    protected: false,
  },
